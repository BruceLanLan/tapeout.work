import {
  ...
  CIRCUIT_MARKET_ADDRESS, BEM_MINING_ADDRESS, BEM_TASKBANK_URL, BEM_MINERS_URL, BEM_PRICE_URL, BEM_PRICE_PAIR_URL, BEM_PRICE_PROVIDER, BEM_CHAIN_ID,
} from "./constants.js";
...
import { bemMiningOverview, bemPriceOverview, bemTasks, bemAlgorithm, bemLeaderboardOverview, BEM_RPC_METRICS } from "./bem.js";
...
export async function v1(request, env) {
  ...
  if (url.pathname === "/api/v1/catalog") return json({
    ...
    endpoints: ["/api/v1/catalog", "/api/v1/openapi.json", "/api/v1/i18n", "/api/v1/updates", "/api/v1/tools", "/api/v1/learn/resources", "/api/v1/glossary", "/api/v1/bem/budget-quote", "/api/v1/official-assets/overview", "/api/v1/official-assets/addresses", "/api/v1/official-assets/health", "/api/v1/official-assets/candles", "/api/v1/community/processor-leaderboard", "/api/v1/community/processor-health", "/api/v1/summary", "/api/v1/analytics", "/api/v1/daily-activity", "/api/v1/protocol-pulse", "/api/v1/airdrop-overview", "/api/v1/market-overview", "/api/v1/bem/overview", "/api/v1/bem/price", "/api/v1/bem/tasks", "/api/v1/bem/algorithm", "/api/v1/bem/leaderboard", "/api/v1/data-health", "/api/v1/events", "/api/v1/processors", "/api/v1/creators", "/api/v1/attestations", "/api/v1/changes", "/api/v1/export.csv", "/api/v1/source-status", "/api/v1/strategies/schema"]
  });
