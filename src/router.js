...
export async function v1(request, env) {
  ...
  if (url.pathname === "/api/v1/openapi.json") return json({
    ...
    paths: {
      ...
      "/api/v1/ecosystem/health": { get: { summary: "Self-probed HEAD/GET reachability check of every curated ecosystem tool's own URL, at most once per 60 minutes per tool. Not uptime history, content correctness or an endorsement of the linked tool." } },
