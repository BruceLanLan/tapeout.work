...
if (!page.includes('id="language-select"') || !page.includes('app.js?v=2026-08-31-features-r30')) throw new Error('Production i18n check failed: locale selector or r12 app asset missing');
