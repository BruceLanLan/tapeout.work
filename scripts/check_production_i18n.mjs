...
if (!page.includes('id="language-select"') || !page.includes('app.js?v=2026-08-29-clubfix-r27')) throw new Error('Production i18n check failed: locale selector or r12 app asset missing');
