...
assert(page.includes('id="learn"') && page.includes('id="learning-nav-menu"') && page.includes('id="mechanics"') && page.includes('official-asset-source-strip') && page.includes('id="official-asset-lens-grid"') && page.includes('id="transistor-candle-chart"') && page.includes('learning.css?v=2026-08-31-features-r36') && page.includes('app.js?v=2026-08-31-features-r36'), 'learning navigation, mechanics section or versioned responsive asset missing');
console.log(JSON.stringify({
  ...
  responsive_asset: 'learning.css?v=2026-08-31-features-r36',
  app_asset: 'app.js?v=2026-08-31-features-r36',
}, null, 2));
