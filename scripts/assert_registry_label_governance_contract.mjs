...
assert(page.includes('app.js?v=2026-08-31-features-r30'), 'page must use r12 application cache key');
assert(app.includes('/i18n/${language}.json?v=2026-08-31-features-r30') && app.includes('/i18n/learning/${language}.json?v=2026-08-31-features-r30'), 'dynamic UI and learning packs must use r12 cache keys');
