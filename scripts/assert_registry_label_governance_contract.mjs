...
assert(page.includes('app.js?v=2026-09-01-features-r43'), 'page must use r12 application cache key');
assert(app.includes('/i18n/${language}.json?v=2026-09-01-features-r43') && app.includes('/i18n/learning/${language}.json?v=2026-09-01-features-r43'), 'dynamic UI and learning packs must use r12 cache keys');
